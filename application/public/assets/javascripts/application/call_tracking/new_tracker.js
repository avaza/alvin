...
function set_websocket(){
    ...
    success: function (data, status, xhr) {
        ...
        Ape = new ApeConnection(function () {
            Ape.subscribe(['global_messages', 'restore', 'provision', 'system_status', 'support_tunnel', 'update_status', 'system_restart', 'ldap_import', 'sound_recording', 'meteor_alive', 'meteor_user_status', 'meteor_phone_status', 'meteor_queue_status', 'provider_status', 'conference_status', 'queue_status', 'user_status', 'port_status', 'call_event', 'presence_event', 'call_update', 'channel_callstate', 'channel_hangup', 'user_'+validUsername]);
