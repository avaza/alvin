...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="full-ui">
   ...
   $(document).ready(function () { $('#noJSWarning').remove(); }); // Try again on ready, just in case the browser didn't recognize the DOM yet
    ...
    <div id="all">
      <div style="clear: both" id="bottomClearer"></div>
      ...
      <div id="presenceBar">
  <div class="wrap">
          <div class="hook validUsername"></div>
    <div class="logoutButton" id="presenceBarLogoutButton">Log out<span class="cap"></span></div>
    <div class="logoutButton blockExtensions" id="presenceBarCCCButton">Call-control Client<span class="cap"></span></div>
    <div id="presBarSTHeartbeat"><img src="/images/st_heartbeat.png" width="30" height="20" alt="Support Tunnel" title="Support Tunnel Active" /></div>
    <!-- div id="presBarFSHeartbeat"><img src="/images/fs_heartbeat.png" width="30" height="20" alt="heartbeat" /></div -->
    <div class="versionInfo" id="presBarVersionInfo"></div>
  </div>
</div>

<script type="text/javascript">
  setTimeout(function () {
    $('#presenceBarLogoutButton').bind('click', logout);
  }, 50);
</script>
