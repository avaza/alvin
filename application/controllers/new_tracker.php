...
class New_tracker extends Alvin_Controller {
    ...
    function link_uuid($uuid){  
        header('Content-Type: application/x-json; charset=utf-8');
        echo(json_encode($this->call_data->link_uuid($uuid)));
    }
    ...
    function post_call(){
        if(($this->input->post('ajax')) == '1'){
            ...
            $this->form_validation->set_rules('r_or_i', 'Routed or Interpreted', 'trim|required'); 
            header('Content-Type: application/x-json; charset=utf-8');
